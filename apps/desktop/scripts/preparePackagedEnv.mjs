...
const allowedKeys = new Set([
  ...
  "LISTEN_AI_MODEL",
  "LISTEN_AI_BASE_URL",
  "LISTEN_TRANSLATION_ENABLED",
  "LISTEN_TRANSLATION_SOURCE_LANGUAGE",
  "LISTEN_TRANSLATION_TARGET_LANGUAGE",
  "LISTEN_TRANSCRIPTION_FLUSH_MS",
  "LISTEN_TRANSCRIPTION_FLUSH_BYTES",
  "DEEPGRAM_MODEL",
  "DEEPGRAM_LANGUAGE",
  "GOOGLE_CLIENT_ID",
